...
sudo chmod -R 777 /tmpdata/project/riscv/wuzw/rocketchip_firstV/rocket-chip/src/main/scala/smartvector
sed -i '/object FCMA extends App {/,/^}/d' /tmpdata/project/riscv/wuzw/rocketchip_firstV/rocket-chip/src/main/scala/smartvector/darecreek/exu/fu/fp/fudian/FCMA.scala
sed -i '/object FCMA extends App {/,/^}/d' /tmpdata/project/riscv/wuzw/rocketchip_firstV/rocket-chip/src/main/scala/smartvector/darecreek/exu/vfu/fp/fudian/FCMA.scala
# 在下面两个文件中
