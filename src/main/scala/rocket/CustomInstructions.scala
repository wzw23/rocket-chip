...
object CustomInstructions {
  ...
  def CUSTOM0_RS1        = BitPat("b0????????????????010?????0001011")
  def CUSTOM0_RS1_RS2    = BitPat("b0????????????????011?????0001011")
  def CUSTOM0_RD         = BitPat("b0????????????????100?????0001011")
  def CUSTOM0_RD_RS1     = BitPat("b0????????????????110?????0001011")
  def CUSTOM0_RD_RS1_RS2 = BitPat("b0????????????????111?????0001011")
